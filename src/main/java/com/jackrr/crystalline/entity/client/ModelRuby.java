...
public class ModelRuby extends EntityModel<LivingEntityRenderState> {
    ...
    public void setupAnim(LivingEntityRenderState state) {
        ...
        // Arms
        this.r_arm.xRot =
                Mth.cos(walkPos * 0.6662F) * walkSpeed;

        this.l_arm.xRot =
                Mth.cos(walkPos * 0.6662F + Mth.PI) * walkSpeed;
        ...
        // Head movement
        this.head.xRot =
                Mth.cos(walkPos * 0.6662F) * walkSpeed * 0.15F;

        this.head.yRot =
                Mth.cos(walkPos * 0.3331F) * walkSpeed * 0.1F;
    }
}